...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, firstName: $firstName, lastName: $lastName, speciality: $speciality, phoneNumber: $phoneNumber, countryCode: $countryCode, categories: $categories, urlToProfileImage: $urlToProfileImage)';
  }
...
abstract class _User implements User {
  const factory _User(
      ...
      required Country countryCode,
      required Categories categories,
      required String urlToProfileImage}) = _$_User;
