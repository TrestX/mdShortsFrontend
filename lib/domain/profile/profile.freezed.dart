...
mixin _$UserProfile {
  ...
  Specialities get speciality => throw _privateConstructorUsedError;
...
class _$_UserProfile implements _UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(id: $id, email: $email, firstName: $firstName, lastName: $lastName, speciality: $speciality, phoneNumber: $phoneNumber, countryCode: $countryCode, categories: $categories, urlToProfileImage: $urlToProfileImage, address: $address, about: $about, designation: $designation)';
  }
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile(
      ...
      required Map<String, String> address,
      required String about,
      required String designation}) = _$_UserProfile;
